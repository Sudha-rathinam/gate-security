...
const styles = StyleSheet.create({
  ...
  label: { color: COLORS.muted, fontSize: 13, marginBottom: 4, fontFamily: FONTS.semiBold },
  inputContainer: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  icon: { marginLeft: 8 },
  input: { flex: 1, color: COLORS.secondary, fontSize: 15, fontFamily: FONTS.regular },
  underlinedInput: { paddingVertical: 6 },
  errorText: { color: '#EF4444', fontSize: 11, marginTop: 4, fontFamily: FONTS.medium },
});
