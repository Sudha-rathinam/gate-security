...
export default StyleSheet.create({
  ...
  avatarMiniText: { color: '#FFFFFF', fontSize: 16, fontFamily: FONTS.bold },
  welcomeText: { color: COLORS.muted, fontSize: 12, fontFamily: FONTS.medium },
  staffName: { color: COLORS.secondary, fontSize: 18, fontFamily: FONTS.bold },
  sectionTitle: { color: COLORS.secondary, fontSize: 16, fontFamily: FONTS.bold, marginBottom: 12, marginTop: 4 },
  ...
  actionBtnText: { color: '#FFFFFF', fontSize: 13, letterSpacing: 0.5, fontFamily: FONTS.bold },
  actionBtnDesc: { color: 'rgba(255,255,255,0.7)', fontSize: 10, fontFamily: FONTS.medium, marginTop: 4 },
  ...
  typeIconText: { fontSize: 16, fontFamily: FONTS.bold },
  activityMain: { flex: 1 },
  activityLabel: { color: COLORS.secondary, fontSize: 14, fontFamily: FONTS.bold },
